...
import { Shield, Building2, GraduationCap, UserCheck, Sparkles, LogOut, User as UserIcon, Settings, Menu, X, KeyRound, BookOpen, Briefcase, DollarSign } from 'lucide-react';
